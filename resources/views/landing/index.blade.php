...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row lg:max-w-6xl lg:mx-auto lg:items-center">
        <div class=" md:mt-5 lg:mt-15 mb-5 px-4 py-4">
        ...
        <div class="mt-5 md:mt-16 lg:mt-8 mb-10 px-5 md:w-full lg:w-[80%]">
            <swiper-container class="mySwiper w-32 lg:w-40" effect="cards" grab-cursor="true">
